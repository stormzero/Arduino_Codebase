// Saved by Simulator for Arduino V0.98.B.3 refer to arduino.com.au
// Stimulus(test.sti)
/*
// Saved by Simulator for Arduino V0.98B
 ...
 Ideal as a simple egg timeror other timer. Easily add a buzzer
 
 This code is public domain but you buy me a beer if you use this 
 and we meet someday (Beerware license).
 
 !!!!! GET THIS DISPLAY BEFORE STARTING THIS PROGJECT  !!!!
