...
void loop() 
{
  static int desiredGrillTemp=0;
    ...
    Serial.print("Food Probes 1-3 = ");  Serial.print(getTemp(FOOD_PROBE_1_PIN));  Serial.print(", ");
    Serial.print(getTemp(FOOD_PROBE_2_PIN));  Serial.print(", ");  Serial.print(getTemp(FOOD_PROBE_3_PIN));  Serial.print("\n");
